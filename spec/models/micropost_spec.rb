...
describe Micropost do
  ...
  before do
    @micropost = user.microposts.create(content: "Lorem")
  end
  ...
  describe "from_users_followed_by" do
    ...
    let(:followed_post) {user.microposts.create!(content: "bar") }
    let(:unfollowed_post) {user.microposts.create!(content: "baz") }
